...
**求职意向：数据分析实习生**  
📧 chenming@email.com | 🔗 [github.com/chenming](https://github.com/chenming) | 上海

---

## 👨‍💻 关于我

统计学专业大三在读，熟练掌握 Python 数据处理与可视化（Pandas、Matplotlib、Seaborn），能独立完成从数据清洗到业务洞察的全流程分析。习惯于用数据讲故事，喜欢从杂乱的数据里找到逻辑。

---

## 🛠 技能

- **语言**：Python（Pandas、NumPy、Matplotlib、Seaborn）、SQL、Markdown  
- **工具**：Jupyter Notebook、Tableau、Excel、Git  
- **分析能力**：数据清洗、探索性分析、RFM 模型、漏斗分析、假设检验
...
**统计学 本科** | XX大学 | 2022–2026  
主修课程：概率论、数理统计、多元统计分析、Python 数据分析

---

*本作品集使用 GitHub Pages 搭建，持续更新中。*
